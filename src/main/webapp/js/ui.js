        ...
        $.ajax({
            ...
            beforeSend: function (request) {
                if (access_token !== undefined) {
                    request.setRequestHeader("Authorization", "Bearer " + access_token.id_token);
                }
            },
            url: url,
            dataType: "json",
...
function getAccessToken() {
    try {
        var auth_response = getCurrentUser().getAuthResponse();
